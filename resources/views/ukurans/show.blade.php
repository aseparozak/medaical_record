                ...
                <div class="p-6 space-y-2">
                    ...
                    <div id="printable-content" class="space-y-2">
                        <div class="header text-center mb-4">
                            <h4 style="font-weight: bold; font-family: 'Roboto', sans-serif;">Medical Record Refraksi</h4>
                        ...
                        <div class="space-y-2">
                            <div class="bg-gray-50 p-4 rounded-md">
                                <div class="grid grid-cols-1 gap-1 text-sm">
                                    ...
                                    <div>
                                        <span class="text-gray-600">Pemeriksa:</span>
                                        <span class="font-medium">{{ $ukuran->examiner->name ?? 'Tidak ada' }}</span>
                                    </div>
                                </div>
                            </div>
