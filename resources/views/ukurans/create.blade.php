            ...
            <div class="max-w-6xl mx-auto sm:px-3 lg:px-6 mb-6 mt-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-1 text-gray-900">
                        <div class="max-w-2xl mb-4 mt-4 px-4">
                            ...
                            <div class="flex mb-2">
                                <select name="patient_id" id="patient_id" class="w-2/3 border rounded px-3 py-2">
                                ...
                                <a href="{{ route('patients.create') }}" class="button">+Pasien</a>  
                        ...
                        <div class="mb-4 px-4">
                            <label for="examiner_id" class="block text-l font-medium text-blue-700">Pemeriksa:</label>
                            <select name="examiner_id" id="examiner_id" class="w-2/6 border rounded px-3 py-2">
                                <option value="">Pilih Pemeriksa </option>
                                @forelse($examiners ?? [] as $examiner) // Menambahkan ?? [] untuk menghindari error
                                    <option value="{{ $examiner->id }}" {{ old('examiner_id') == $examiner->id ? 'selected' : '' }}>
                                        {{ $examiner->name }}
                                    </option>
                                @empty
                                    <option value="" disabled style="color: red;">Tidak ada data pemeriksa</option>
                                @endforelse
                            </select>
                            <a href="{{ route('examiners.create') }}" class="button">+Pemeriksa</a>  
